...
* DC: Define constant <ETIQUETA> DC.<TAMA�O> <ITEM>,<ITEM>,.. 
* A partir de la dir de memoria ETIQUETA se almacena <ITEM>, cada uno con TAMA�O

* DS: Define storage <ETIQUETA> DS.<TAMA�O> <LONGITUD>
...
SCAN    	LINK     A6,#-24          * creamos el marco de pila 24B para guardar 6 registros de 4B.
			...
			MOVE.W   14(A6),D4        * D4 tama�o.	
			CMP.W 	 #0,D4			  * si tama�o es 0 salto SCANZ 
			BEQ 	 SCANZ
...
****************************** SCAN_A **********************************
************************************************************************
* D4=tama�o(numero max de caracteres a leer y copiar) D5=descriptor(A o B), A3=direccion del buffer.
...
SCAN_A     	MOVE.L   #0,D0 		    * parametro de entrada de LEECAR es 0(buffer A de recepcion)
			...
			CMP.L D2,D4             * comparamos n� de datos leidos (D2) con tama�o D4.
...
******************************** PRINT *********************************
************************************************************************
* A3 = Direccion Buffer 	D4 = Tama�o     D5 = Descriptor(0 -linea A, 1 -linea B)
...
PRINT    	LINK     A6,#-28          * creamos el marco de pila 28B para guardar 7 registros de 4B.
			...
			MOVE.W   12(A6),D5        * D5 descriptor.
			MOVE.W   14(A6),D4        * D4 tama�o.
			CMP.W 	 #0,D4			  * si tama�o es 0 salto a PRINTZ 
			BEQ 	 PRINTZ
...
****************************** PRINT_A *********************************
************************************************************************
* D4=tama�o, D5=descriptor, A3=direccion del buffer
...
****************************** PRINT_B *********************************
************************************************************************
* D4=tama�o, A3=direccion del buffer.
...
TAMBS:  	EQU 4 						* Tama�o de bloque para SCAN
TAMBP:  	EQU 4 						* Tama�o de bloque para PRINT	
